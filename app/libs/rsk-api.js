...
var rskConf = require('../config/rsk-conf');


var RskApi = function (conf) {
...
RskApi.prototype.sendRequest = function(params, callback, errorCallback) {
  var options = this.generateRequestOptions(
    params.endpoint,
    params.method,
    params.headers,
    params.query,
...
RskApi.prototype.getTwoLeggedToken = function(callback) {
  this.sendRequest(
    ...
    function (proxyErr, proxyRes, proxyBody) {
      var body = JSON.parse(proxyBody) || false;
